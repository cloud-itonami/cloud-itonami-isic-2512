# Business Model: Manufacture of tanks, reservoirs and containers of metal
...
## Classification
- Repository: `cloud-itonami-isic-2512` ([github.com/cloud-itonami/cloud-itonami-isic-2512](https://github.com/cloud-itonami/cloud-itonami-isic-2512))
- ISIC Rev.5: `2512` — Manufacture of tanks, reservoirs and containers of metal
- Domain: `:metal-tank-reservoir-container/manufacturing`
- Social impact: :worker-safety :materials-safety :resource-efficiency
- Actor: `:metal-tank-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :metal-tank-reservoir-container/manufacturing — who wants
...
One managed tenant (:metal-tank-reservoir-container/manufacturing):
...
- Do not bypass the `:metal-tank-plant-operations-governor` for production decisions.
