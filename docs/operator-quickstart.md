# Operator Quickstart — Manufacture of tanks, reservoirs and containers of metal

Shortest path from clone to a verified local dry-run for **ISIC 2512** (`cloud-itonami-isic-2512`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2512.git
cd cloud-itonami-isic-2512
```
...
- Blueprint governor key: `metal-tank-plant-operations-governor`
- Likely source path: `metaltankmfg.governor.cljc`
