(ns metaltankmfg.phase
  "Phase 0->3 staged rollout for the metal-tank/reservoir/container
  fabrication shop plant-operations coordination actor.
  ...
  consequence (a welding-line/pressure-test-rig/forming-line
  ...
  `metaltankmfg.governor`'s `welding-line-actuate-blocked-violations`
...
(defn verdict->disposition
  "Map a Metal Tank Plant Operations Governor verdict to a base
